...
from routes.render_pages.render_users import bp_render_users
...
from routes.reports_controller import bp_reports
...
def config_bps(app):
    ...
    app.register_blueprint(bp_reports, url_prefix=prefix)